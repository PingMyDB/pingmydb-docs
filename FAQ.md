...
The Student plan offers enhanced features at a heavily discounted rate ($0.99/mo). 
...
### What are the Pro and Enterprise limits?
- **Student ($0.99/mo)**: 1-hour interval, 3-day logs.
- **Pro ($3.99/mo)**: 1-hour interval, 15-day logs.
- **Enterprise ($9.99/mo)**: Starting from 5-minute interval, 30-day logs, and up to 150 databases.
